...
for task in tqdm(tasks):
    ...
    y = np.array(motion_data_task["subject_ids"].tolist())[mask]
    groups = np.array(motion_data_task["run_labels"].tolist())[mask]
...
plt.ylabel("Task")
plt.title("Subject classification based on motion parameters")
